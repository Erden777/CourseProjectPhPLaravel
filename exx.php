    ...
    $link = mysqli_connect("localhost", "root", "", "web_mid");
        ...
        if(count($err) == 0)
        {
              ...
              if(!empty($_POST["name"]) && !empty($_POST["email"]) && !empty($_POST["pass"]) && !empty($_POST["contact"])){
                ...
                $query = mysqli_query($link,"INSERT INTO users (full_name, number, email, job, pass, country) VALUES ('$name','$contact','$email','$job','$pass','$country')");
              }
        }
    ?>
...
<article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <div class="form-group input-group">
    	<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-globus"></i> </span>
		</div>
...
<!--
    <input name="job" type="text" placeholder="Job" class="form-control">
-->
	</div> <!-- form-group end.// -->
    <div class="form-group input-group">
    	<div class="input-group-prepend">
